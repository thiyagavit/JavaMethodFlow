...
public class GraphViz
{
   ...
   private String TEMP_DIR = "N:/Sources/dev.CIAM/SampleParser/temp";	// Windows

   /**
    * Where is your dot program located? It will be called externally.
    */
   //private static String DOT = "/usr/bin/dot";	// Linux
   private String DOT = "c:/Program Files/Graphviz2.38/bin/dot.exe";	// Windows
    ...
    * a graph.
    */
   public GraphViz(String dotLoc, String tempDir) {
	   this.DOT = dotLoc;
